  ...
  include 'header.php'; ?>
    ...
    <section class="career">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3>CAREER <span>FORM</span></h3>
                    <p>At Sachlo, we believe that a company is only as strong as the people who work together within our
                        organization. That’s why at Sachlo we strive towards building strong management teams and as
                        part of this.</p>
                </div>
            </div>
                    ...
                    <form method="post" enctype="multipart/form-data" action="">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input required placeholder="Full Name" class="form-control" name="name" id="fullname"
                                    type="text" />
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <input required placeholder="Email Address" class="form-control" name="email" id="email"
                                    type="email" />
                            </div>

                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <label class="required"> * Please enter mobile number in 9665XXXXXXXX format
                                    only</label>
                                <input required placeholder="Mobile Number" class="form-control" name="mobile"
                                    id="mobile" type="text" />
                            </div>

                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <label class="required"> * Select PDF file only</label>
                                <input required="" class="form-control " name="file" id="file" type="file"
                                    accept="application/pdf">

                            </div>

                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <label class="required"> * Less than 500 characters</label>
                                <textarea required placeholder="Message" class="form-control min-hei" name="message"
