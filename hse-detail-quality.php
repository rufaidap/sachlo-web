    ...
    <section class="hse_detail">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-8">
                    <h3>QUALITY</h3>
                    <p>Keeping in view the climatic changing scenarios of the World, SACHLO Management is very much
                        concerned to put in their best for the conservation of environment to make this globe a worth
                        living place. SACHLO is certified for ISO 9001:2015 and equipped with Quality Control Lab to
                        ensure the quality of Raw Material, In process parameters and finished products according to
                        standards given by the technology supplier. To achieve the goal of precision &amp; Accuracy, we
                        have inducted Highly qualified staff, sophisticated instruments &amp; most advance Laboratory
                        Information Management system (LIMS).</p>
                    <div class="bx"><img src="images/quality-logo.jpg" alt="Chemical manufacturers Saudi Arabia"></div>
                </div>
                <div class="col-lg-4"><img src="images/hse-environment.jpg" alt="Chemical manufacturers Saudi Arabia">
                </div>
            </div>
        </div>
    </section>
