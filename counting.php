    ...
    <div class="row">    
      <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="bx border-eff">
          ...
          <div id="counter"><h3><div class="counter-value" data-count="200">0</div>+</h3></div> 
          <h5>Clients</h5>
        </div>
      </div>
      <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="bx border-eff">
          ...
          <h3><div class="counter-value" data-count="200">0</div>+</h3>
          <h5>Employees</h5>
        </div>
      </div> 
      <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="bx border-eff">
          ...
          <h3><div class="counter-value" data-count="8">0</div>M+</h3>
          <h5>Safe Man Hours</h5>
        </div>
      </div>                
    </div>
