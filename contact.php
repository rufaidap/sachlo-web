                    ...
                    <div class="wi">
                        ...
                        <div class="row">
                                ...
                                <form method="post" enctype="multipart/form-data" action="">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            ...
                                            <input required placeholder="Full Name" class="form-control" name="name" id="name" type="text" />
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <input required placeholder="Email Address" class="form-control" name="email" id="email" type="email" />
                                        </div>

                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <input required placeholder="Mobile Number(9665XXXXXXXX)" class="form-control" name="mobile" id="mobile" type="text" />
                                        </div>

                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <select name="products" id="products" class="form-control" required="">
                                                <option value="">Select a Product</option>
                                                <option value="Liquefied Chlorine">Liquefied Chlorine</option>
                                                <option value="Caustic Soda">Caustic Soda</option>
                                                <option value="Caustic Soda Flakes">Caustic Soda Flakes</option>
                                                <option value="Hydrochloric Acid 32%">Hydrochloric Acid 32%</option>
                                                <option value="Sodium Hypochlorite 12%">Sodium Hypochlorite 12%</option>
                                                <option value="Calcium Chloride 36% Liquid">Calcium Chloride 36% Liquid</option>
                                                <option value="Calcium Chloride ‐ 77% ‐ 78% Flakes">Calcium Chloride ‐ 77% ‐ 78% Flakes</option>
                                                <option value="Calcium Chloride ‐ 94% Prills">Calcium Chloride ‐ 94% Prills</option>
                                            </select>
                                        </div>

                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <textarea required placeholder="Message(Maximum 500 characters)" class="form-control min-hei" name="message" id="message" type="text"></textarea>
                                        </div>
                            ...
                            <div class="col-lg-5 col-md-12">
                                ...
                                <p><a href="tel:+966554637242">Phone: +966 554637242</a></p>
                                <p><a href="tel:+966118123870">Phone: +966 11 8123870</a></p>
                                <!--<p><a href="tel:+966552427364">Phone: +966 552427364</a></p>-->
                                <p><a href="mailto:info@sachlo.com">Email: info@sachlo.com</a></p>
                                
                                <h6 class="mt-3">Sachlo:</h6>
                                <p><a href="tel:+966114155824">Phone: +966 11 415 5824</a></p>

                                <h6 class="mt-3">Information Technology:</h6>
                                <p><a href="tel:+966555401054">Phone: +966 55 540 1054</a></p>

                                <h4>Find us.</h4>
                                <p>SACHLO, FWRG+5JC, Riyadh 14545, Saudi Arabia</p>
