    ...
    <section class="hse_detail">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-8">
                    <h3> البيئة </h3>
                    <p> تعتبر حماية البيئة من أهم التحديات التي تواجه العالم اليوم. بالنسبة إلى ساكلو ، هذا مهم جدًا
                        لأن العديد من منتجاتنا تشكل خطورة على صحة الإنسان والبيئة. في ساكلو ، نحن ملتزمون بتقليل تأثير
                        عملياتنا على البيئة. تم اعتماد ساكلو لنظام إدارة البيئة ISO 14001: 2015 والتحسين المستمر من
                        خلال الشركة </p>
