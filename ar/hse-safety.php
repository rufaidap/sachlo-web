        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-8 text-right">
                    <h3> السلامة </h3>
                    <p> السلامة في ساكلو هي واحدة من أهم جوانب عملياتنا اليومية ، ومسألة سلامة الموظفين هي أمر نأخذه
                        على محمل الجد. يتم دعم فريقنا بنظام إدارة صارم وفعال ، وتلتزم ساكلو بالحفاظ على معاييرنا
                        العالية من خلال إجراءات محددة جيدًا ومتبعة بعناية تضمن تلبية أو تنفيذ المتطلبات الوطنية والدولية
                    </p>
