        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-8 text-right">
                    <h3> الجودة </h3>
                    <p> مع الأخذ في الاعتبار السيناريوهات المتغيرة للمناخ في العالم ، تهتم إدارة ساكلو كثيرًا ببذل
                        قصارى جهدها للحفاظ على البيئة لجعل هذا العالم مكانًا يستحق العيش فيه. ساكلو حاصلة على شهادة ISO
                        9001: 2015 ومجهزة بمختبر مراقبة الجودة لضمان جودة المواد الخام ، ومعلمات العملية والمنتجات
                        النهائية وفقًا للمعايير التي قدمها مورد التكنولوجيا. لتحقيق هدف الدقة & أمبير. الدقة ، لقد قمنا
                        بتعيين موظفين مؤهلين تأهيلا عاليا ، وأدوات متطورة وأمبير. نظام إدارة معلومات المختبر الأكثر
                        تقدمًا (LIMS). </p>
